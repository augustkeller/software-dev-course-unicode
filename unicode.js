...
let lastLetterCode = inputString2.charCodeAt(5);
let swappedString = String.fromCharCode(lastLetterCode) + inputString2.slice(1, 4) + String.fromCharCode(firstLetterCode); // Your code here
